...
import com.example.bottomnavigation.Model.Top;
...
public class ThongKeDAO {
    ...
    public List<Top> getTop() {
        String sqlTop = "SELECT maSach, count(maSach) as soLuong " +
                "FROM PhieuMuon GROUP BY maSach ORDER BY soLuong DESC LIMIT 10";
